...
public:
     ...
     */
    SSD1289_LCD(PinName CS, PinName RS, PinName WR, PinName DIR, PinName EN, PinName LE, BusOut* DATA_PORT,  PinName RD , PinName BL = NC, backlight_t blType = Constant, float defaultBackLightLevel = 1.0 );
