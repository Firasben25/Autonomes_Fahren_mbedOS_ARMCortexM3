...
public:
    ...
    *
    */    
    void Create( const char* name, unsigned short x1, unsigned short y1,SSD1289_LCD *lcd, TouchScreenADS7843 *touch, unsigned short x2 = 0, unsigned short y2 = 0);
...
protected:        
    ...
    *touched and set button_touched to false
    */
    void ResetButtonsTouched(Button *button, int button_first, int button_last, SSD1289_LCD *LCD, int skip = -1);
    
    /*
    * If switching between menus, draw last status of the buttons
    */
    void DrawLastButtonsStatus(Button *button, int button_first, int button_last,SSD1289_LCD *LCD, int skip = -1);
