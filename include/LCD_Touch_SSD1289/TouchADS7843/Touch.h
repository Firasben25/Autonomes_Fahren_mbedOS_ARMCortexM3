...
public:
    ...
    *
    */
    //TouchScreenADS7843(PinName tp_mosi, PinName tp_miso, PinName tp_sclk, PinName tp_cs, PinName tp_irq, ILI9328_LCD *_LCD);
    TouchScreenADS7843(PinName tp_mosi, PinName tp_miso, PinName tp_sclk, PinName tp_cs, PinName tp_irq, SSD1289_LCD *_LCD);
    
/////////////////////////////////////////////////
    /*
    * Set the Touchcalibration on default values without 
    * reading User's touch inputs
    *
    */
    void setCalibrationwithoutUser();    
////////////////////////////////////////////////
    /*
