...
void Button::Create(const char* name, unsigned short x1, unsigned short y1, ILI9328_LCD *lcd, TouchScreenADS7843 *touch, unsigned short x2, unsigned short y2)
{
...
void ResetButtonsTouched(Button *button, int button_first, int button_last, ILI9328_LCD *LCD, int skip)
{
    int i;
...
void DrawLastButtonsStatus(Button *button, int button_first, int button_last, ILI9328_LCD *LCD, int skip)
{
    int i;
